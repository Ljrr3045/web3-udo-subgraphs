...
export class DistributeRewards extends ethereum.Event {
  get params(): DistributeRewards__Params {
    return new DistributeRewards__Params(this);
  }
}

export class DistributeRewards__Params {
  _event: DistributeRewards;

  constructor(event: DistributeRewards) {
    this._event = event;
  }
